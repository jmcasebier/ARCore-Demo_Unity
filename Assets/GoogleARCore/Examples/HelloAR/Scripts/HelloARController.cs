...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    public class HelloARController : MonoBehaviour
    {
        ...
        /// <summary>
        /// The objects related to plane visualization.
        /// </summary>
        ...
        /// <summary>
        /// True if the user has placed the enemy,
        /// otherwise false.
        /// </summary>
        ...
        public void Update()
        {
            ...
            // Should not handle input if the player has already placed the enemy.
            if (m_IsPlaced)
            {
                return;
            }
                ...
                else
                {
                    ...
                    if (hit.Trackable is DetectedPlane)
                    {
                        ...
                        if (detectedPlane.PlaneType == DetectedPlaneType.HorizontalUpwardFacing)
                        {
                            ...
                            // Disable the objects related to plane visualization.
                            PlaneDiscovery.SetActive(false);
                            PlaneGenerator.SetActive(false);

                            // Disable additional placement
                            m_IsPlaced = true;                                                        
                        }
                    }
                }
